  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row font-sans">
      ...
      <aside className="w-full md:w-64 bg-white border-r border-gray-200 flex flex-col">
        <div className="p-4 md:p-6 border-b border-gray-200 flex items-center justify-between md:justify-start gap-2">
          ...
          <div className="flex items-center gap-2 md:hidden">
            <button onClick={() => navigate('/')} className="p-2 text-gray-600 hover:bg-gray-100 rounded-full transition-colors" title="Voltar ao Site">
              <ArrowLeft size={18} />
            </button>
        ...
        <nav className="p-4 space-y-1 md:space-y-1 flex gap-2 md:flex-col md:flex-1 overflow-x-auto">
          <button
            onClick={() => setActiveTab('users')}
            className={`flex-1 md:w-full flex items-center justify-center md:justify-start gap-2 md:gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-colors whitespace-nowrap ${activeTab === 'users' ? 'bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'}`}
          >
            <Users size={18} /> Usuários
          </button>
          <button
            onClick={() => setActiveTab('invitations')}
            className={`flex-1 md:w-full flex items-center justify-center md:justify-start gap-2 md:gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-colors whitespace-nowrap ${activeTab === 'invitations' ? 'bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900'}`}
          >
